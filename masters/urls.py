...
urlpatterns = [
    ...
    path('studyprograms/<int:pk>/', StudyProgramDetail.as_view(), name='studyprogramdetail'),
    path('periods/', RegistrationPeriodList.as_view(), name='periods'),
    path('periods/<int:pk>/', RegistrationPeriodDetail.as_view(), name='periodlist'),
    path('schools/', SchoolList.as_view(), name='Schools'),
    path('schools/<int:pk>/', SchoolDetail.as_view(), name='Schoollist'),
